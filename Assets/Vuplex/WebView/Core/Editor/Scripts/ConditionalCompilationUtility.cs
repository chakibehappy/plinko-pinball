    ...
    static class ConditionalCompilationUtility
    {
        ...
        public static bool enabled
        {
            get
            {
                ...
                return PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget).Contains(k_EnableCCU);
        ...
        static void UpdateDependencies(bool reset = false)
        {
            ...
            var namedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(buildTargetGroup);
            var previousProjectDefines = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
            ...
            if (!projectDefines.Contains(k_EnableCCU, StringComparer.OrdinalIgnoreCase))
            {
                ...
                PlayerSettings.SetScriptingDefineSymbols(namedBuildTarget, string.Join(";", projectDefines));
